        ...
        >
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link" @click="$router.push('/Map')"
                  >Карта учебных заведений</a
                >
              </li>
              <li class="nav-item">
    ...
    <div class="filter-container">
        <div>
          ...
          >
            <img
              v-if="isSidebarOpen"
              src="@/components/img/BackArrow.png"
              alt="Back"
            />
            <img v-else src="@/components/img/ForwardArrow.png" alt="Forward" />
          </button>
        </div>

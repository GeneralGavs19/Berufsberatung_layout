      ...
      <div class="portal-background">
        <div class="portal-background-title">
          ...
          <button
            ...
            class="btn btn-light btn-lg header-button"
          >
            <h2>Register</h2>
          </button>
        </div>
        <img
          src="@/components/img/PortalBackground.png"
          class="portal-background-img"
          ...
          <p>
            ...
            <div class="portal-block-content">
              <div class="portal-block-card">
                ...
                <p>
                  Выбирайте дату, время и <br>
                  формат мероприятия <br>
                  — онлайн или офлайн
                </p>
              </div>
            </div>
...
export default {
  ...
  const maxScroll = 700;
  const newOpacity = Math.max(1 - scrollTop / maxScroll, 0.4); // Минимальная яркость 70%

  scrollOpacity.value = newOpacity;
  console.log("scrollTop:", scrollTop, "scrollOpacity:", scrollOpacity.value);
};
